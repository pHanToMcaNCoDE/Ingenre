      ...
      <h1 className='text-[1.3rem] font-mono tracking-wiser pb-[2em]'>Top Rated Anime</h1>
        ...
        <section className='py-[4em]'>
          <div className='flex justify-center items-center duration-300 hover:-translate-x-2 relative hover:-translate-y-2'>
            ...
            <button onMouseEnter={() => setHoveredButton(true)} onMouseLeave={() => setHoveredButton(false)} className='duration-300 hover:-translate-x-2 hover:-translate-y-2 flex items-center gap-x-3 bg-blue-50 absolute border-2 border-blue-300 rounded-[.3rem] px-2 py-1 text-blue-400 w-[10em] h-[3em] font-mono tracking-widest'>
